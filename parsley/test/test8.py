...
##@package parsley.test.test8
## Test: directory trashing
...
if "syncs" in globals():
    ...
    write2file("m/_dummy", "")  # otherwise the other dir gets empty which is a bad thing for the watchdog
    SYNC()
    time.sleep(1)
    verify(readfile("s/d1/d2/d3/d4/d5/f1") == "f1", "m f1")
    ...
    verify(listdir("m/d1/d2") == ["f3"], "m d2 contains just f3")
